...
type ISkillsServices interface {
	SkillsSearch(ctx context.Context, request models.SkillsRequest) ([]models.SkillsResponse, error)
...
func (services *SkillsServices) SkillsSearch(ctx context.Context, request models.SkillsRequest) ([]models.SkillsResponse, error) {
